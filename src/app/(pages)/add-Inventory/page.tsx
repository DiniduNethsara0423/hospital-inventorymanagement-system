  ...
  return (
    <div className="p-10 bg-white rounded-md">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex flex-col">
          <label className="text-md font-medium text-gray-700 mb-1">Item Type</label>
          <div className="flex gap-4">
            <label className="flex items-center space-x-2">
              <input
                ...
                name="item_type"
                value="machine"
                checked={formData.item_type === "machine"}
            ...
            <label className="flex items-center space-x-2">
              <input
                ...
                name="item_type"
                value="spare_parts"
                checked={formData.item_type === "spare_parts"}
                onChange={handleRadioChange}
                className="form-radio text-blue-600"
              />
        ...
        <div className="flex flex-col">
          <label htmlFor="maintenance_date" className="text-md font-medium text-gray-700 mb-1">
            Maintenance Date
          </label>
          <input
            id="maintenance_date"
